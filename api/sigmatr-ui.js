...
/* SELO — aptidão da função (crachá aceso) e estado "faltam X" */
.st-selo{background:linear-gradient(135deg,#0F4CBA,#0B3A91);color:#fff;border-radius:16px;
  padding:26px 22px;text-align:center;box-shadow:0 8px 24px rgba(15,76,186,.28)}
.st-selo-check{display:inline-flex;align-items:center;gap:6px;background:rgba(255,255,255,.18);
  border-radius:999px;padding:5px 12px;font-size:12px;font-weight:700;letter-spacing:.5px;margin-bottom:10px}
.st-selo-nome{font-family:'Exo 2',sans-serif;font-size:22px;font-weight:800;margin:2px 0}
.st-selo-funcao{font-size:14px;opacity:.9;margin-bottom:16px}
.st-selo-qr{background:#fff;border-radius:12px;padding:12px;display:inline-block;margin:2px 0 14px;line-height:0}
.st-selo-qr canvas,.st-selo-qr img{display:block;margin:0 auto}
.st-selo-val{font-size:13px;opacity:.92}
.st-selo-cod{font-family:ui-monospace,monospace;font-size:13px;letter-spacing:2px;margin-top:6px;opacity:.9}
.st-faltam{background:#fff;border:1px solid #E5E7EB;border-radius:12px;padding:24px 20px;text-align:center;
  box-shadow:0 1px 2px rgba(16,24,40,.06)}
.st-faltam-num{font-family:'Exo 2',sans-serif;font-size:44px;font-weight:800;color:#0F4CBA;line-height:1;margin:6px 0}
.st-faltam h2{margin:2px 0 4px;font-size:19px;color:#1F2937;font-weight:700}
.st-faltam p{margin:4px 0;font-size:13.5px;color:#6B7280;line-height:1.5}
.st-faltam-prog{height:8px;background:#E5E7EB;border-radius:999px;overflow:hidden;margin:14px 0}
.st-faltam-prog>span{display:block;height:100%;background:#22C55E;transition:width .4s}
`;
